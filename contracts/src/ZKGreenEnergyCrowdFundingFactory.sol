...
import "./ZKGreenEnergyCrowdFunding.sol";

contract ZKGreenEnergyCrowdFundingFactory is Ownable {
    ...
    function deployCampaign(
        ...
        ZKGreenEnergyCrowdFunding(deployment).initialize(
            recipient,
            minGoal,
            maxGoal,
            minContribution,
            ...
            _feeTransferBips,
            _feeYieldBips,
            regulatoryComplianceScoreThreshold,
