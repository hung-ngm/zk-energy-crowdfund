...
echo "Deploying campaign to Base Sepolia"
...
VERIFIER_ADDRESS="0x56C1a83A4682837528b04292AF27ef648aC6dDab"
TOKEN_ADDRESS="0x7C65d5C1497472B5Dd0434D681FBe619935D1fF4"
DEPLOYER_ADDRESS="0x0EB1Bb029eCc7Ed1bac818a26f59F36a25801883"

#########

DEPLOY_SIG="deployCampaign(address,uint256,uint256,uint256,uint256,uint32,uint32,address,uint256,uint256,address)"
DEPLOY_ETH_ARGS=(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 100000000000 100000000000000000 1 1000000000 0 5000000 0x0000000000000000000000000000000000000000 85 4 ${VERIFIER_ADDRESS})
...
DEPLOY_ERC20_ARGS=(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 100000000000 100000000000000000 1 1000000000 0 5000000 ${TOKEN_ADDRESS} 85 4 ${VERIFIER_ADDRESS})
